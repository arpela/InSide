...
public class FileterReportBakingBean {
	...
	public void find(){
		...
		try {
			...
			if ((nameDivice != null) && (!nameDivice.trim().equals(""))){				
				...
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage (FacesMessage.SEVERITY_ERROR, 
						BundleUtil.getMessageResource("reporteDiff.error.filter.value"), BundleUtil.getMessageResource("reporteDiff.error.filter.value")));
			}
		...
		if (!retorno.toString().trim().equals(""))
